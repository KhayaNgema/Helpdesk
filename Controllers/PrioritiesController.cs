...
namespace Helpdesk.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriorityId,PriorityNo,PriorityName")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriorityId,PriorityNo,PriorityName")] Priority priority)
        {
            if (ModelState.IsValid)
            {
